            ...
            firebase.database().ref('fcmTokens').child(friend_id).once('value').then(function (data) {
                $.ajax({
                    ...
                    headers: {
                        ...
                        'Authorization': 'key=AAAAo2jDc3E:APA91bEgNJzAwWxEnOjPtc12NL_Dae6oAPvtv8_N71v8F8-qIIpiQe4PWkDRSWRVx8XrCgcGIFhlDNKcGb5Pb7eosSrLDXyaeNT-FoEgQrIr8G5_sBI3XbGUl42aHc8jgsFn7UYzdeWW'
                    },
                    data: JSON.stringify({
